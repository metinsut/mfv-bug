      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            ...
            "rounded-md bg-foreground px-3 py-1.5 text-xs text-background has-data-[slot=kbd]:pe-1.5",
            "data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-start-2",
            "data-[side=inline-start]:slide-in-from-end-2 data-[side=left]:slide-in-from-right-2",
        ...
        >
          ...
          <TooltipPrimitive.Arrow
            className={cn(
              ...
              "data-[side=bottom]:top-1 data-[side=inline-end]:top-1/2! data-[side=inline-end]:-inset-s-1",
