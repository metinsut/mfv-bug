...
const buttonVariants = cva(
  cn(
    ...
    "border border-transparent bg-clip-padding text-xs/relaxed font-medium whitespace-nowrap",
    "transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2",
    "focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none",
